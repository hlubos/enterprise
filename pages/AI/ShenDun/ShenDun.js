...
Page({
  ...
  onReady: function (t) {
    ...
    wx.setKeepScreenOn({
      ...
      setTimeout(function () {
        ;(i.ctx = wx.createCanvasContext('canvas')),
          (i.audioCtx = wx.createInnerAudioContext()),
          (i.appearCtx = wx.createInnerAudioContext()),
          i.downloadAudios(),
          (i.backgroundVideo = i.selectComponent('#backgroundVideo')),
          i.initClassifier()
  ...
  satisfyFrame: function (t, i) {
    var a = this,
      e = !0,
      n = 20 * this.data.pixelRatio
    return (
      Array.isArray(i) &&
        Array.isArray(t) &&
        i.forEach(function (i) {
          ;(!t[i] ||
            t[i].position.x < a.data.left_point_pos - n ||
            t[i].position.x > a.data.right_point_pos + n ||
            t[i].position.y > 0.9 * a.data.videoHeight + n ||
            t[i].position.y < 0.15 * a.data.videoHeight - n) &&
            (e = !1)
        }),
      e
    )
  ...
  matchPoint: function (t, i, a) {
    ...
    return (
      t.forEach(function (t) {
        ;(Math.abs(t.position.x - i) > 50 * e.data.pixelRatio ||
          Math.abs(t.position.y - a) > 50 * e.data.pixelRatio) &&
          (n = !1)
      }),
      n
    )
    ...
    return (
      ...
      (e.forEach(function (n, o) {
        if (0 !== o) {
          var r = !1
          t.forEach(function (t) {
            var a = Math.abs(n[t].position.x - e[o - 1][t].position.x),
              s = Math.abs(n[t].position.y - e[o - 1][t].position.y)
  ...
  isOutScreen: function () {
    var t = this,
      ...
      a = this
    if (this.data.gameEnd) this.clearTimer()
    else {
      var e = [5, 6],
        n = a.isMoving(e)
            ...
            (a.notMovingTimer = setInterval(function () {
              a.setData(
                ...
                function () {
                  ...
                  else if (6 === a.data.notMovingTimer)
          ...
          i.classifier
            ...
            .then(function (t) {
              ...
              if (!e.data.gameEnd) {
                ...
                if (e.satisfyConf(n, 0.2, o) && e.isInBox(o))
                  if (e.data.gameStart || e.timer) {
                    if (!e.data.countDown) {
                      ...
                      var r =
                        ...
                        s = (n[11].position.y + n[12].position.y) / 2
                      ...
                      e.data.show_tip &&
                        ...
                        !1 === e.data.actionAry[e.data.actionAry.length - 1]
                          ...
                          : !0 !==
                              e.data.actionAry[e.data.actionAry.length - 1] ||
                            e.data.doStand ||
                            (s > e.data.hip_knee_mid_line + 20 &&
                              e.setData({
                                doStand: !0,
  ...
  initClassifier: function () {
    ...
    var e = a.windowWidth / 2 - 0.2 * a.windowHeight,
      n = a.windowWidth - e
    this.setData({
