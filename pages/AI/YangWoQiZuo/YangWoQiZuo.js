...
Page({
    ...
    return (
      Array.isArray(e) &&
        ...
        e.forEach(function (e) {
          ;(!t[e] ||
            t[e].position.x < i.data.left_point_pos - 40 ||
            t[e].position.x > i.data.right_point_pos + 40 ||
            t[e].position.y > 0.9 * i.data.videoHeight + 40 + 20 ||
            t[e].position.y < 0.1 * i.data.videoHeight - 20) &&
            (a = !1)
        }),
      a
    )
  ...
  triggerGameStart: function () {
    ...
    a(),
      clearInterval(e.startTimer),
      (e.startTimer = setInterval(a, 1e3)),
      (e.timer = setInterval(function () {
        e.data.countDown > 0
          ? e.setData({
              countDown: e.data.countDown - 1,
              countDownSrc:
                e.data.countDownSrcAry[e.data.countDown - 1 == 2 ? 1 : 0],
            })
  ...
  matchPoint: function (t, e, i) {
    ...
    return (
      t.forEach(function (t) {
        ;(Math.abs(t.position.x - e) > 60 || Math.abs(t.position.y - i) > 60) &&
          (a = !1)
      }),
      a
    )
    ...
    return (
      ...
      (a.forEach(function (n, o) {
        if (0 !== o) {
          var r = !1
          t.forEach(function (t) {
            var i = Math.abs(n[t].position.x - a[o - 1][t].position.x),
              s = Math.abs(n[t].position.y - a[o - 1][t].position.y)
  ...
  isTooClose: function (t) {
    var e = this
    t > 0.95 * this.data.videoHeight &&
      (e.data.justRing ||
        e.data.gameEnd ||
        (e.playMusic('tooClose'),
        e.setData(
          {
            show_in_box: !0,
          },
  ...
  isOutScreen: function () {
    ...
    i.data.time != i.data.recordTime &&
      ...
      !n || e
        ? i.notMovingTimer ||
          (i.notMovingTimer = setInterval(function () {
            i.setData(
              {
                notMovingTimer: i.data.notMovingTimer
                  ? i.data.notMovingTimer + 1
                  : 1,
              },
              function () {
                if (3 === i.data.notMovingTimer) t.playMusic('keepMoving')
                else if (6 === i.data.notMovingTimer) t.playMusic('keepMoving')
                else if (9 === i.data.notMovingTimer && i.data.time > 10) {
                  var e = 5,
                    a = function () {
                      e > 0
                        ? (e <= 3
        ...
        : (clearInterval(i.notMovingTimer),
          (i.notMovingTimer = null),
          clearInterval(i.endTimer),
          (i.endTimer = null),
          i.setData({
            notMovingTimer: 0,
      ...
      this.setData(
        ...
        function () {
          e.classifier
            .detectSinglePose(t)
            .then(function (t) {
              if (i.data.time <= 0 && !i.isTimeEnding)
                return (
                  (i.isTimeEnding = !0),
                  i.uploadScore(),
                  void i.setData(
              ...
              if (!i.data.gameEnd) {
                ...
                var n, o, r
                ;(n = i.data.knee_line || a[14].position.y),
                  a[12].position.y,
                  (o = a[10].position.y),
                  'right',
                  (r = i.maxConfinencePoint([a[2], a[4], a[0]])).score < 0.2 &&
                    (r = i.maxConfinencePoint([r, a[10]]))
                a[0].position.y
                var s = o < n && r.score > 0.2,
                  c = s && a[14].score > 0.2
                if (i.data.doClose || i.satisfyConf(a, 0.2, [14]))
                  if (i.data.gameStart || i.timer || !c) {
                    if (!i.data.countDown && i.data.gameStart)
                      if (
                        (i.isOutScreen(),
                        i.data.doClose &&
                          !1 === i.data.actionAry[i.data.actionAry.length - 1])
                      )
                        (a[0].position.y > i.data.knee_line ||
                          (a[0].score < 0.2 && a[10].score < 0.2)) &&
                          i.setData({
                            doClose: !1,
                            actionAry: i.data.actionAry.concat(!0),
                          })
                      else if (
                        !0 === i.data.actionAry[i.data.actionAry.length - 1] &&
                        !i.data.counting
                      ) {
                        0 === i.data.num &&
                          i.setData({
  ...
  initClassifier: function () {
    ...
    var a = i.windowWidth / 2 - 0.1 * i.windowHeight,
      n = i.windowWidth - a
    this.setData({
