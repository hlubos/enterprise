...
Page({
    ...
    return (
      Array.isArray(i) &&
        ...
        i.forEach(function (i) {
          ;(!t[i] ||
            t[i].position.x < a.data.left_point_pos - 80 ||
            t[i].position.x > a.data.right_point_pos + 80 ||
            t[i].position.y > 0.9 * a.data.videoHeight + 40 + 40 ||
            t[i].position.y < 0.1 * a.data.videoHeight - 40) &&
            (e = !1)
        }),
      e
    )
  ...
  matchPoint: function (t, i, a) {
    ...
    return (
      t.forEach(function (t) {
        ;(Math.abs(t.position.x - i) > 35 * e.data.widthMulti ||
          Math.abs(t.position.y - a) > 35 * e.data.widthMulti) &&
          (n = !1)
      }),
      n
    )
          ...
          i.classifier
            ...
            .then(function (t) {
              ...
              if (!e.data.gameEnd) {
                ...
                var o = [5, 6, 13, 14, 15, 16],
                  r = (n[15].position.y + n[16].position.y) / 2
                if (e.satisfyConf(n, 0.2, o))
                    ...
                    if (!e.data.countDown && e.data.gameStart) {
                      ...
                      if (
                        ...
                        e.matchPoint(
                          ...
                          (n[9].position.y > s || n[10].position.y > s) &&
                          e.data.canAdd &&
                        ...
                        var c = e.data.videoWidth / e.data.videoHeight,
                          d =
                            Math.abs(e.data.jumpY - 0.9 * e.data.videoHeight) *
                            c,
                          u = e.data.left_point_pos + d,
                          h = e.data.jumpY,
                          l = e.data.right_point_pos - d,
                          m = e.data.jumpY,
                          p = n[5].position.y,
                          g =
                            n[15].position.x < n[16].position.x ? n[15] : n[16],
                          f =
                            n[15].position.x > n[16].position.x ? n[15] : n[16]
                        e.matchPoint([g], u, h) &&
                          e.setData(
                          ...
                          (n[9].position.y < p || n[10].position.y < p) &&
                            e.setData(
                              {
                                top_mid: !0,
                                bot_mid: !1,
  ...
  initClassifier: function () {
    ...
    var e = a.windowWidth / 2 - 0.175 * a.windowHeight,
      n = a.windowWidth - e
    this.setData({
